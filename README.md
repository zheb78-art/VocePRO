...
Per flussi molto grandi è disponibile anche **Scegli cartella** nella modalità audioguida. L'app legge tutti i TXT, mostra le lingue realmente trovate e permette di selezionarne una, alcune o tutte prima dell'invio. Crea poi un job per ogni combinazione file-lingua selezionata e lavora a blocchi fino a 50 MP3: invia un blocco, attende che tutti i job siano terminati, salva tutti gli MP3 nella cartella scelta sul computer e soltanto allora avvia la pausa di 60 secondi prima del blocco successivo. Se Gemini esaurisce prima la quota di token in coda, l'app chiude il blocco al numero già accettato, salva gli MP3, attende 60 secondi e riprende automaticamente dai rimanenti. Gli MP3 sono organizzati in sottocartelle `ita`, `eng`, `deu`, ecc. La pagina deve restare aperta fino al completamento e al salvataggio dell'ultimo blocco.
